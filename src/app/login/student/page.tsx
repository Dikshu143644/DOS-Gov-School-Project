...
export default function StudentLoginPage() {
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-28">
      <h1 className="text-2xl font-semibold text-white">Student / Applicant Login</h1>
      <p className="mt-3 text-sm text-white/65">
        Secure login ships with V0 identity module. Applicants will track
        admission status; enrolled students will access their digital profile.
      </p>
      <div className="glass-panel mt-8 rounded-2xl p-6">
        <p className="text-sm text-white/50">Preview — form disabled</p>
        <label className="mt-4 block text-xs text-white/60">Application ID or Student ID</label>
        <input
          disabled
